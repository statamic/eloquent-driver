...
class SubmissionQueryBuilderTest extends TestCase
{
    ...
    public function it_filters_using_or_wheres()
    {
        ...
        $this->assertEquals(['a', 'b', 'd'], $submissions->map->get('id')->values()->all());
    }
    ...
    public function it_filters_using_or_where_not_ins()
    {
        ...
        $submissions = FormSubmission::query()->whereNotIn('test', ['foo', 'bar'])->orWhereNotIn('test', ['foo', 'bar', 'raz'])->get();

        $this->assertEquals(['c', 'e', 'f'], $submissions->map->get('id')->values()->all());
    }
    ...
    public function submissions_are_found_using_where_time()
    {
        ...
        $entries = FormSubmission::query()->whereTime('date', '09:00:00')->get();
    ...
    {
        $form = tap(Form::make('test'))->save();
        FormSubmission::make()->form($form)->data(['title' => 'Post 1'])->date(1637008264)->save();
        FormSubmission::make()->form($form)->data(['title' => 'Post 2'])->date(1636621200)->save();
        FormSubmission::make()->form($form)->data(['title' => 'Post 3'])->date(1636934400)->save();
        FormSubmission::make()->form($form)->data(['title' => 'Post 4'])->date(1600008264)->save();
    }
    ...
    public function submissions_are_found_using_or_where_json_doesnt_contain()
    {
        ...
        $this->assertEquals(['1', '2', '3', '4'], $entries->map->get('id')->all());
    }
